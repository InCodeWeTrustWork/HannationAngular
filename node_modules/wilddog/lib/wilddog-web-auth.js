...
var k=this;function aa(){}
function l(a){var b=typeof a;if("object"==b)if(a){if(a instanceof Array)return"array";if(a instanceof Object)return b;var c=Object.prototype.toString.call(a);if("[object Window]"==c)return"object";if("[object Array]"==c||"number"==typeof a.length&&"undefined"!=typeof a.splice&&"undefined"!=typeof a.propertyIsEnumerable&&!a.propertyIsEnumerable("splice"))return"array";if("[object Function]"==c||"undefined"!=typeof a.call&&"undefined"!=typeof a.propertyIsEnumerable&&!a.propertyIsEnumerable("call"))return"function"}else return"null";else if("function"==
b&&"undefined"==typeof a.call)return"object";return b}function n(a){return"string"==typeof a}function p(a){return"function"==l(a)}function ba(a){var b=typeof a;return"object"==b&&null!=a||"function"==b}function ca(a,b,c){return a.call.apply(a.bind,arguments)}
...
function fa(a,b){function c(){}c.prototype=b.prototype;a.za=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.ta=function(a,c,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[c].apply(a,g)}};function ga(a,b,c,d,e){this.uid=e;this.displayName=a;this.email=b;this.photoURL=c;this.providerId=d};function t(a,b){if(1==arguments.length){this.g=a.split("/");for(var c=0,d=0;d<this.g.length;d++)0<this.g[d].length&&(this.g[c]=this.g[d],c++);this.g.length=c;this.o=0}else this.g=a,this.o=b}t.prototype.toString=function(){for(var a="",b=this.o;b<this.g.length;b++)""!==this.g[b]&&(a+="/"+this.g[b]);return a||"/"};t.prototype.slice=function(a){return this.g.slice(this.o+(a||0))};
t.prototype.b=function(a){for(var b=[],c=this.o;c<this.g.length;c++)b.push(this.g[c]);if(a instanceof t)for(c=a.o;c<a.g.length;c++)b.push(a.g[c]);else for(a=a.split("/"),c=0;c<a.length;c++)0<a[c].length&&b.push(a[c]);return new t(b,0)};t.prototype.contains=function(a){var b=this.o,c=a.o;if(this.g.length-this.o>a.g.length-a.o)return!1;for(;b<this.g.length;){if(this.g[b]!==a.g[c])return!1;++b;++c}return!0};new t("");var ha={NETWORK_ERROR:"Unable to contact the Wilddog server.",SERVER_ERROR:"An unknown server error occurred.",TRANSPORT_UNAVAILABLE:"There are no login transports available for the requested method.",REQUEST_INTERRUPTED:"The browser redirected the page before the login request could complete.",USER_CANCELLED:"The user cancelled authentication."};function u(a){var b=Error(ia(ha,a),a);b.code=a;return b};function ja(){return"undefined"!==typeof window&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(navigator.userAgent)}function ka(){return"undefined"!==typeof location&&/^file:\//.test(location.href)}
function la(){if("undefined"===typeof navigator)return!1;var a=navigator.userAgent;if("Microsoft Internet Explorer"===navigator.appName){if((a=a.match(/MSIE ([0-9]{1,}[\.0-9]{0,})/))&&1<a.length)return 8<=parseFloat(a[1])}else if(-1<a.indexOf("Trident")&&(a=a.match(/rv:([0-9]{2,2}[\.0-9]{0,})/))&&1<a.length)return 8<=parseFloat(a[1]);return!1};function ia(a,b){if(Object.prototype.hasOwnProperty.call(a,b))return a[b]}function ma(a,b){for(var c in a)Object.prototype.hasOwnProperty.call(a,c)&&b(c,a[c])}function na(a){var b={};ma(a,function(a,d){b[a]=d});return b};function v(a){this.F=a;this.I="wilddog:"}v.prototype.set=function(a,b){null==b?this.F.removeItem(this.I+a):this.F.setItem(this.I+a,w(b))};v.prototype.get=function(a){a=this.F.getItem(this.I+a);return null==a?null:x(a)};v.prototype.remove=function(a){this.F.removeItem(this.I+a)};v.prototype.toString=function(){return this.F.toString()};function oa(){this.C={}}oa.prototype.set=function(a,b){null==b?delete this.C[a]:this.C[a]=b};oa.prototype.get=function(a){return Object.prototype.hasOwnProperty.call(this.C,a)?this.C[a]:null};oa.prototype.remove=function(a){delete this.C[a]};function pa(a){try{if("undefined"!==typeof window&&"undefined"!==typeof window[a]){var b=window[a];b.setItem("wilddog:sentinel","cache");b.removeItem("wilddog:sentinel");return new v(b)}}catch(c){}return new oa}var qa=pa("localStorage"),y=pa("sessionStorage");function ra(a,b,c){this.H=a||{};this.G=b||{};this.i=c||{};this.H.remember||(this.H.remember="default")}var sa=["remember","redirectTo"];function z(a){var b={},c={};ma(a||{},function(a,e){0<=ta(sa,a)?b[a]=e:c[a]=e});return new ra(b,{},c)};function A(a,b,c,d){var e;d<b?e="at least "+b:d>c&&(e=0===c?"none":"no more than "+c);if(e)throw Error(a+" failed: Was called with "+d+(1===d?" argument.":" arguments.")+" Expects "+e+".");}function ua(a,b,c){var d="";switch(b){case 1:d=c?"first":"First";break;case 2:d=c?"second":"Second";break;case 3:d=c?"third":"Third";break;case 4:d=c?"fourth":"Fourth";break;default:throw Error("errorPrefix called with argumentNumber > 4.  Need to update it?");}return a=a+" failed: "+(d+" argument ")}
function B(a,b,c,d){if(!(d&&void 0===c||p(c)))throw Error(ua(a,b,d)+"must be a valid function.");};function va(a,b,c){this.h=c;this.f=a;this.j=b;this.c=0;this.b=null}va.prototype.get=function(){var a;0<this.c?(this.c--,a=this.b,this.b=a.next,a.next=null):a=this.f();return a};function wa(a,b){a.j(b);a.c<a.h&&(a.c++,b.next=a.b,a.b=b)};function xa(a){this.b=a}xa.prototype.toString=function(){return this.b};var ya=new xa("IFRAME"),za=new xa("SCRIPT");function Aa(a){a=String(a);if(/^\s*$/.test(a)?0:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/(?:"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)[\s\u2028\u2029]*(?=:|,|]|}|$)/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,"")))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);}function Ba(){}
function Ca(a,b,c){if(null==b)c.push("null");else{if("object"==typeof b){if("array"==l(b)){var d=b;b=d.length;c.push("[");for(var e="",f=0;f<b;f++)c.push(e),Ca(a,d[f],c),e=",";c.push("]");return}if(b instanceof String||b instanceof Number||b instanceof Boolean)b=b.valueOf();else{c.push("{");e="";for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&(f=b[d],"function"!=typeof f&&(c.push(e),Da(d,c),c.push(":"),Ca(a,f,c),e=","));c.push("}");return}}switch(typeof b){case "string":Da(b,c);break;case "number":c.push(isFinite(b)&&
!isNaN(b)?String(b):"null");break;case "boolean":c.push(String(b));break;case "function":c.push("null");break;default:throw Error("Unknown type: "+typeof b);}}}var Ea={'"':'\\"',"\\":"\\\\","/":"\\/","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\u000b"},Fa=/\uffff/.test("\uffff")?/[\\\"\x00-\x1f\x7f-\uffff]/g:/[\\\"\x00-\x1f\x7f-\xff]/g;
function Da(a,b){b.push('"',a.replace(Fa,function(a){var b=Ea[a];b||(b="\\u"+(a.charCodeAt(0)|65536).toString(16).substr(1),Ea[a]=b);return b}),'"')};function C(a){var b=[];ma(a,function(a,d){"array"==l(d)?Ga(d,function(d){b.push(encodeURIComponent(a)+"="+encodeURIComponent(d))}):b.push(encodeURIComponent(a)+"="+encodeURIComponent(d))});return b.length?"&"+b.join("&"):""}function Ha(a){var b={};a=a.replace(/^\?/,"").split("&");Ga(a,function(a){a&&(a=a.split("="),b[a[0]]=a[1])});return b}function x(a){return"undefined"!==typeof JSON&&void 0!==JSON.parse?JSON.parse(a):Aa(a)}
function w(a){if("undefined"!==typeof JSON&&void 0!==JSON.stringify)a=JSON.stringify(a);else{var b=[];Ca(new Ba,a,b);a=b.join("")}return a};function Ia(a,b){var c=window;c.attachEvent?c.attachEvent("on"+a,b):c.addEventListener&&c.addEventListener(a,b,!1)}function Ja(a,b){var c=window;c.detachEvent?c.detachEvent("on"+a,b):c.removeEventListener&&c.removeEventListener(a,b,!1)}function Ka(a){/^https?:\/\//.test(a)||(a=window.location.href);var b=/^(https?:\/\/[\-_a-zA-Z\.0-9:]+)/.exec(a);return b?b[1]:a}
function La(a){var b="";try{a=a.replace("#","");var c=Ha(a);c&&Object.prototype.hasOwnProperty.call(c,"__wilddog_request_key")&&(b=ia(c,"__wilddog_request_key"))}catch(d){}return b}function Ma(){var a=Na();return a.scheme+"://"+a.host+"/v2"}function Oa(a){return Ma()+"/"+a+"/auth/channel"};function D(a){a.callback_parameter||(a.callback_parameter="callback");this.b=a;window.__wilddog_auth_jsonp=window.__wilddog_auth_jsonp||{}}
D.prototype.open=function(a,b,c){function d(){c&&(c(u("REQUEST_INTERRUPTED")),c=null)}function e(){setTimeout(function(){window.__wilddog_auth_jsonp[f]=void 0;var a;a:{a=window.__wilddog_auth_jsonp;for(var b in a){a=!1;break a}a=!0}a&&(window.__wilddog_auth_jsonp=void 0);try{var c=document.getElementById(f);c&&c.parentNode.removeChild(c)}catch(d){}},1);Ja("beforeunload",d)}var f="fn"+(new Date).getTime()+Math.floor(99999*Math.random());b[this.b.callback_parameter]="__wilddog_auth_jsonp."+f;a+=(/\?/.test(a)?
"":"?")+C(b);Ia("beforeunload",d);window.__wilddog_auth_jsonp[f]=function(a){c&&(c(null,a),c=null);e()};Pa(f,a,c)};
function Pa(a,b,c){setTimeout(function(){try{var d=document.createElement("script");d.type="text/javascript";d.id=a;d.async=!0;d.src=b;d.onerror=function(){var b=document.getElementById(a);null!==b&&b.parentNode.removeChild(b);c&&c(u("NETWORK_ERROR"))};var e,f=document.getElementsByTagName("head");f&&0!=f.length?e=f[0]:e=document.documentElement;e.appendChild(d)}catch(g){c&&c(u("NETWORK_ERROR"))}},0)}D.isAvailable=function(){return!NODE_CLIENT};D.prototype.D=function(){return"json"};function Qa(){this.b=E()+E()+E()}Qa.prototype.open=function(a,b){y.set("redirect_request_id",this.b);y.set("redirect_request_id",this.b);b.requestId=this.b;b.redirectTo=b.redirectTo||window.location.href;a+=(/\?/.test(a)?"":"?")+C(b);window.location=a};Qa.isAvailable=function(){return!NODE_CLIENT&&!ka()&&!ja()};Qa.prototype.D=function(){return"redirect"};function F(a){a.method||(a.method="GET");a.headers||(a.headers={});a.headers["Content-Type"]||(a.headers["Content-Type"]="application/json");a.headers["Content-Type"]=a.headers["Content-Type"].toLowerCase();this.b=a}
F.prototype.open=function(a,b,c){function d(){c&&(c(u("REQUEST_INTERRUPTED")),c=null)}var e=new XMLHttpRequest,f=this.b.method.toUpperCase(),g;Ia("beforeunload",d);e.onreadystatechange=function(){if(c&&4===e.readyState){var a;if(200<=e.status&&300>e.status){try{a=x(e.responseText)}catch(b){}c(null,a)}else 500<=e.status&&600>e.status?c(u("SERVER_ERROR")):c(u("NETWORK_ERROR"));c=null;Ja("beforeunload",d)}};if("GET"===f)a+=(/\?/.test(a)?"":"?")+C(b),g=null;else{var h=this.b.headers["Content-Type"];"application/json"===
h&&(g=w(b));"application/x-www-form-urlencoded"===h&&(g=C(b))}e.open(f,a,!0);a={"X-Requested-With":"XMLHttpRequest",Accept:"application/json;text/plain"};Ra(a,this.b.headers);for(var m in a)e.setRequestHeader(m,a[m]);e.send(g)};F.isAvailable=function(){return!NODE_CLIENT&&!!window.XMLHttpRequest&&(!("undefined"!==typeof navigator&&(navigator.userAgent.match(/MSIE/)||navigator.userAgent.match(/Trident/)))||la())};F.prototype.D=function(){return"json"};var Sa="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Ra(a,b){for(var c,d,e=1;e<arguments.length;e++){d=arguments[e];for(c in d)a[c]=d[c];for(var f=0;f<Sa.length;f++)c=Sa[f],Object.prototype.hasOwnProperty.call(d,c)&&(a[c]=d[c])}};function E(){return Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^ea()).toString(36)};var ta=Array.prototype.indexOf?function(a,b,c){return Array.prototype.indexOf.call(a,b,c)}:function(a,b,c){c=null==c?0:0>c?Math.max(0,a.length+c):c;if(n(a))return n(b)&&1==b.length?a.indexOf(b,c):-1;for(;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1},Ga=Array.prototype.forEach?function(a,b,c){Array.prototype.forEach.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=n(a)?a.split(""):a,f=0;f<d;f++)f in e&&b.call(c,e[f],f,a)},Ta=Array.prototype.filter?function(a,b,c){return Array.prototype.filter.call(a,
b,c)}:function(a,b,c){for(var d=a.length,e=[],f=0,g=n(a)?a.split(""):a,h=0;h<d;h++)if(h in g){var m=g[h];b.call(c,m,h,a)&&(e[f++]=m)}return e},Ua=Array.prototype.map?function(a,b,c){return Array.prototype.map.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=Array(d),f=n(a)?a.split(""):a,g=0;g<d;g++)g in f&&(e[g]=b.call(c,f[g],g,a));return e};
function Va(a,b){var c;a:{c=a.length;for(var d=n(a)?a.split(""):a,e=0;e<c;e++)if(e in d&&b.call(void 0,d[e],e,a)){c=e;break a}c=-1}return 0>c?null:n(a)?a.charAt(c):a[c]}function Wa(a,b){a.sort(b||Xa)}function Xa(a,b){return a>b?1:a<b?-1:0};function Ya(){this.c=this.b=null}var $a=new va(function(){return new Za},function(a){a.reset()},100);Ya.prototype.remove=function(){var a=null;this.b&&(a=this.b,this.b=this.b.next,this.b||(this.c=null),a.next=null);return a};function Za(){this.next=this.c=this.b=null}Za.prototype.set=function(a,b){this.b=a;this.c=b;this.next=null};Za.prototype.reset=function(){this.next=this.c=this.b=null};var G;a:{var ab=k.navigator;if(ab){var bb=ab.userAgent;if(bb){G=bb;break a}}G=""};function cb(a){k.setTimeout(function(){throw a;},0)}var db;
function eb(){var a=k.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&-1==G.indexOf("Presto")&&(a=function(){var a=document.createElement(String(ya));a.style.display="none";a.src="";document.documentElement.appendChild(a);var b=a.contentWindow,a=b.document;a.open();a.write("");a.close();var c="callImmediate"+Math.random(),d="file:"==b.location.protocol?"*":b.location.protocol+"//"+b.location.host,a=q(function(a){if(("*"==d||a.origin==
d)&&a.data==c)this.port1.onmessage()},this);b.addEventListener("message",a,!1);this.port1={};this.port2={postMessage:function(){b.postMessage(c,d)}}});if("undefined"!==typeof a&&-1==G.indexOf("Trident")&&-1==G.indexOf("MSIE")){var b=new a,c={},d=c;b.port1.onmessage=function(){if(void 0!==c.next){c=c.next;var a=c.L;c.L=null;a()}};return function(a){d.next={L:a};d=d.next;b.port2.postMessage(0)}}return"undefined"!==typeof document&&"onreadystatechange"in document.createElement(String(za))?function(a){var b=
document.createElement(String(za));b.onreadystatechange=function(){b.onreadystatechange=null;b.parentNode.removeChild(b);b=null;a();a=null};document.documentElement.appendChild(b)}:function(a){k.setTimeout(a,0)}};function fb(a,b){gb||hb();ib||(gb(),ib=!0);var c=jb,d=$a.get();d.set(a,b);c.c?c.c.next=d:c.b=d;c.c=d}var gb;function hb(){var a=k.Promise;if(-1!=String(a).indexOf("[native code]")){var b=a.resolve(void 0);gb=function(){b.then(kb)}}else gb=function(){var a=kb,b;!(b=!p(k.setImmediate))&&(b=k.Window&&k.Window.prototype)&&(b=-1==G.indexOf("Edge")&&k.Window.prototype.setImmediate==k.setImmediate);b?(db||(db=eb()),db(a)):k.setImmediate(a)}}var ib=!1,jb=new Ya;
function kb(){for(var a=null;a=jb.remove();){try{a.b.call(a.c)}catch(b){cb(b)}wa($a,a)}ib=!1};function H(a,b){this.b=lb;this.M=void 0;this.f=this.c=this.j=null;this.h=this.u=!1;if(a!=aa)try{var c=this;a.call(b,function(a){I(c,mb,a)},function(a){try{if(a instanceof Error)throw a;throw Error("Promise rejected.");}catch(b){}I(c,J,a)})}catch(d){I(this,J,d)}}var lb=0,mb=2,J=3;function nb(){this.next=this.context=this.c=this.f=this.b=null;this.h=!1}nb.prototype.reset=function(){this.context=this.c=this.f=this.b=null;this.h=!1};var ob=new va(function(){return new nb},function(a){a.reset()},100);
function pb(a,b,c){var d=ob.get();d.f=a;d.c=b;d.context=c;return d}H.prototype.then=function(a,b,c){return qb(this,p(a)?a:null,p(b)?b:null,c)};H.prototype.then=H.prototype.then;H.prototype.$goog_Thenable=!0;H.prototype.W=function(a,b){return qb(this,null,a,b)};function rb(a,b){a.c||a.b!=mb&&a.b!=J||sb(a);a.f?a.f.next=b:a.c=b;a.f=b}
function qb(a,b,c,d){var e=pb(null,null,null);e.b=new H(function(a,g){e.f=b?function(c){try{var e=b.call(d,c);a(e)}catch(r){g(r)}}:a;e.c=c?function(b){try{var e=c.call(d,b);a(e)}catch(r){g(r)}}:g});e.b.j=a;rb(a,e);return e.b}H.prototype.X=function(a){this.b=lb;I(this,mb,a)};H.prototype.ba=function(a){this.b=lb;I(this,J,a)};
function I(a,b,c){if(a.b==lb){a===c&&(b=J,c=new TypeError("Promise cannot resolve to itself"));a.b=1;var d;a:{var e=c,f=a.X,g=a.ba;if(e instanceof H)rb(e,pb(f||aa,g||null,a)),d=!0;else{var h;if(e)try{h=!!e.$goog_Thenable}catch(r){h=!1}else h=!1;if(h)e.then(f,g,a),d=!0;else{if(ba(e))try{var m=e.then;if(p(m)){tb(e,m,f,g,a);d=!0;break a}}catch(r){g.call(a,r);d=!0;break a}d=!1}}}d||(a.M=c,a.b=b,a.j=null,sb(a),b!=J||ub(a,c))}}
function tb(a,b,c,d,e){function f(a){h||(h=!0,d.call(e,a))}function g(a){h||(h=!0,c.call(e,a))}var h=!1;try{b.call(a,g,f)}catch(m){f(m)}}function sb(a){a.u||(a.u=!0,fb(a.T,a))}function vb(a){var b=null;a.c&&(b=a.c,a.c=b.next,b.next=null);a.c||(a.f=null);return b}
H.prototype.T=function(){for(var a=null;a=vb(this);){var b=this.b,c=this.M;if(b==J&&a.c&&!a.h)for(var d=void 0,d=this;d&&d.h;d=d.j)d.h=!1;if(a.b)a.b.j=null,wb(a,b,c);else try{a.h?a.f.call(a.context):wb(a,b,c)}catch(e){xb.call(null,e)}wa(ob,a)}this.u=!1};function wb(a,b,c){b==mb?a.f.call(a.context,c):a.c&&a.c.call(a.context,c)}function ub(a,b){a.h=!0;fb(function(){a.h&&xb.call(null,b)})}var xb=cb;if("undefined"!=typeof Promise)var yb=Promise;else"undefined"!=typeof k.Promise?yb=k.Promise:yb=H;k.setTimeout||(k.setTimeout=function(){global.setTimeout.apply(global,arguments)});H.prototype["catch"]=H.prototype.W;function K(){var a=this;this.c=this.f=null;this.b=new yb(function(b,c){a.f=b;a.c=c})}function L(a,b){return function(c,d){c?a.c(c):a.f(d);p(b)&&(a.b.then(void 0,aa),1===b.length?b(c):b(c,d))}};function M(a,b,c,d){ga.call(this,b.displayName,b.email,b.photoURL,b.providerId,b.uid);this.isAnonymous="anonymous"===this.b;this.emailVerified=!0===c;this.providerData=d||[];this.refreshToken=null;Object.defineProperty(this,"__authManager",{value:a,writable:!1})}fa(M,ga);var N=["wd","User"],O=k;N[0]in O||!O.execScript||O.execScript("var "+N[0]);for(var P;N.length&&(P=N.shift());)N.length||void 0===M?O[P]?O=O[P]:O=O[P]={}:O[P]=M;
M.prototype["delete"]=function(a){var b=new K;zb(this.__authManager,this.l(),L(b,a));return b.b};M.prototype["delete"]=M.prototype["delete"];M.prototype.l=function(){return(this.__authManager.m||null).idToken};M.prototype.getToken=M.prototype.l;
M.prototype.link=function(a,b){A("wilddog.User.link",1,2,arguments.length);Q("wilddog.User.link",a);var c=a.provider,d=new K,e={};e.idToken=this.l();"password"==c?(e.email=a.email,e.password=a.password,Ab(this.__authManager,e,L(d,b))):(e.providerId=a.provider,e.accessToken=a.accessToken,e.openId=a.openId||"",e.authType="link",R(this.__authManager,e,L(d,b)));return d.b};M.prototype.link=M.prototype.link;
M.prototype.ma=function(a,b){A("wilddog.User.unlink",1,2,arguments.length);Bb("wilddog.User.unlink",a);var c=new K,d=this;Cb(this.__authManager,"unlink",{idToken:this.l(),deleteProvider:[a]},L(c,function(c,f){f&&(d.providerData=d.providerData.filter(function(b){if(b.providerId!=a)return b}),0===d.providerData.length&&(S(d.__authManager,null),T(void 0,null)));b&&b(c,f)}));return c.b};M.prototype.unlink=M.prototype.ma;
M.prototype.U=function(a,b){A("wilddog.auth().signInWithPopup",1,2,arguments.length);Q("wilddog.auth().signInWithPopup",a);var c=new K;Db(this.__authManager,a,{authType:"link",idToken:this.l()},L(c,b));return c.b};M.prototype.linkWithPopup=M.prototype.U;M.prototype.V=function(a,b){A("wilddog.auth().signInWithPopup",1,2,arguments.length);Q("wilddog.auth().signInWithPopup",a);var c=new K;Eb(this.__authManager,a,{authType:"link",idToken:this.l()},L(c,b));return c.b};M.prototype.linkWithRedirect=M.prototype.V;
M.prototype.pa=function(a,b){A("wilddog.User.updateProfile",1,2,arguments.length);Q("wilddog.User.updateProfile",a);var c=new K;a.idToken=this.l();Cb(this.__authManager,"profile",a,L(c,b));return c.b};M.prototype.updateProfile=M.prototype.pa;M.prototype.na=function(a,b){A("wilddog.User.updateEmail",1,2,arguments.length);Bb("wilddog.User.updateEmail",a);var c=new K;Ab(this.__authManager,{email:a,idToken:this.l()},L(c,b));return c.b};M.prototype.updateEmail=M.prototype.na;
M.prototype.oa=function(a,b){A("wilddog.User.updatePassword",1,2,arguments.length);Bb("wilddog.User.updatePassword",a);var c=new K;Ab(this.__authManager,{password:a,idToken:this.l()},L(c,b));return c.b};M.prototype.updatePassword=M.prototype.oa;M.prototype.ca=function(a){A("wilddog.User.sendEmailVerification",0,1,arguments.length);B("wilddog.User.sendEmailVerification",1,a,!0);var b=new K;Fb(this.__authManager,{idToken:this.l(),requestType:"VERIFY_EMAIL"},L(b,a));return b.b};
M.prototype.sendEmailVerification=M.prototype.ca;M.prototype.reload=function(a){A("wilddog.User.reload",0,1,arguments.length);B("wilddog.User.reload",1,a,!0);var b=new K;Gb(this.__authManager,this.l(),L(b,a));return b.b};M.prototype.reload=M.prototype.reload;M.prototype.aa=function(a,b){A("wilddog.User.reload",1,2,arguments.length);B("wilddog.User.reload",2,b,!0);if(!a||!a.provider)throw Error("Unknown credential object.");var c=new K;R(this.__authManager,a,L(c,b));return c.b};
M.prototype.reauthenticate=M.prototype.aa;function Hb(a){if(a&&a.users&&a.users[0])return a=a.users[0],new ga(a.displayName,a.email,a.photoUrl,a.providerId,a.localId);throw Error("Bad response format.");}function Ib(a,b){var c=Hb(b);if(!c)return null;var d=b.users[0],e=d.providerUserInfo.map(function(a){a.photoURL=a.photoUrl;delete a.photoUrl;return a});return new M(a,c,d.emailVerified,e)};var Jb=null,Kb=null;function Lb(a){var b="";Mb(a,function(a){b+=String.fromCharCode(a)});return b}function Mb(a,b){function c(b){for(;d<a.length;){var c=a.charAt(d++),e=Kb[c];if(null!=e)return e;if(!/^[\s\xa0]*$/.test(c))throw Error("Unknown base64 encoding at char: "+c);}return b}Nb();for(var d=0;;){var e=c(-1),f=c(0),g=c(64),h=c(64);if(64===h&&-1===e)break;b(e<<2|f>>4);64!=g&&(b(f<<4&240|g>>2),64!=h&&b(g<<6&192|h))}}
function Nb(){if(!Jb){Jb={};Kb={};for(var a=0;65>a;a++)Jb[a]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(a),Kb[Jb[a]]=a,62<=a&&(Kb["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.".charAt(a)]=a)}};function Ob(a,b){if(!a)throw Error("Wilddog ("+Wilddog.qa+") INTERNAL ASSERT FAILED: "+b);}function Pb(a){try{return NODE_CLIENT?(new Buffer(a,"base64")).toString("utf8"):"undefined"!==typeof atob?atob(a):Lb(a)}catch(b){!0===Qb&&(Qb=!1,!0===y.get("logging_enabled")&&Wilddog.ua(!0))}return null}
function Rb(a){for(var b="",c=0;c<arguments.length;c++)var d=arguments[c],e=l(d),b="array"==e||"object"==e&&"number"==typeof d.length?b+Rb.apply(null,arguments[c]):"object"===typeof arguments[c]?b+w(arguments[c]):b+arguments[c],b=b+" ";return b}var Qb=!0;function Sb(a){if("undefined"!==typeof console){var b="WILDDOG WARNING: "+Rb.apply(null,arguments);"undefined"!==typeof console.warn?console.warn(b):console.log(b)}}
function Na(){var a="auth.wilddog.com",b="",c="",d="",e="",f=!0,g="https",h=443;if(n(a)){var m=a.indexOf("//");0<=m&&(g=a.substring(0,m-1),a=a.substring(m+2));m=a.indexOf("/");-1===m&&(m=a.length);b=a.substring(0,m);e="";a=a.substring(m).split("/");for(m=0;m<a.length;m++)if(0<a[m].length){var r=a[m];try{r=decodeURIComponent(r.replace(/\+/g," "))}catch(U){}e+="/"+r}a=b.split(".");3===a.length?(c=a[1],d=a[0].toLowerCase()):2===a.length&&(c=a[0]);m=b.indexOf(":");0<=m&&(f="https"===g||"wss"===g,h=b.substring(m+
1),isFinite(h)&&(h=String(h)),h=n(h)?/^\s*-?0x/i.test(h)?parseInt(h,16):parseInt(h,10):NaN)}return{host:b,port:h,domain:c,ya:d,wa:f,scheme:g,va:e}}function Tb(a){try{a()}catch(b){setTimeout(function(){Sb("Exception was thrown by user callback.",b.stack||"");throw b;},Math.floor(0))}}function T(a,b){if(p(a)){var c=Array.prototype.slice.call(arguments,1).slice();Tb(function(){a.apply(null,c)})}};function Ub(a){Ob("array"==l(a)&&0<a.length,"Requires a non-empty array");this.h=a;this.b={}}Ub.prototype.j=function(a,b){for(var c=this.b[a]||[],d=0;d<c.length;d++)c[d].K.apply(c[d].context,Array.prototype.slice.call(arguments,1))};function Vb(a,b){Ob(Va(a.h,function(a){return a===b}),"Unknown event: "+b)};function V(a,b){Ub.call(this,["authStateChanged","authTokenExpired"]);this.f={N:!1};this.c={};Object.defineProperty(this,"name",{value:b,writable:!1});Object.defineProperty(this,"options",{value:a,writable:!1});var c=this;["auth","sync"].forEach(function(a){c[a]=function(){var b="__"+a,f=k.wilddog.__getService(a);if(!f)throw Error("Could not found module "+a);c[b]||(c[b]=f(this));return c[b]}})}fa(V,Ub);
V.prototype.R=function(a,b){var c=!0,d;for(d in W)if(W.hasOwnProperty(d)&&W[d]===a){c=!1;break}if(c)throw Error("Unknown event "+a);this.c[a]=b;switch(a){case W.s:this.f.N=b&&b.N}this.j(a,b)};V.prototype.emit=V.prototype.R;V.prototype.bind=function(a,b){Vb(this,a);this.b[a]=this.b[a]||[];this.b[a].push({K:b,context:void 0});var c;a:{switch(a){case W.s:c=[this.c[W.s]];break a}c=null}c&&b.apply(void 0,c)};V.prototype.bind=V.prototype.bind;
V.prototype.la=function(a,b){Vb(this,a);for(var c=this.b[a]||[],d=0;d<c.length;d++)if(c[d].K===b){c.splice(d,1);break}};V.prototype.unbind=V.prototype.la;var W={s:"authStateChanged",O:"authTokenExpired"};function Wb(){var a="undefined"!==typeof window?window:global;if(!a.wilddog){a.wilddog={};var b={};a.wilddog.initializeApp=function(b,d){var e=d||"DEFAULT";a.wilddog[e]=new V(b,e);return a.wilddog[e]};a.wilddog.__regService=function(a,d){b[a]=d};a.wilddog.__getService=function(a){return b[a]};["auth","sync"].forEach(function(b){a.wilddog[b]=function(){if(!a.wilddog.DEFAULT)throw Error("App has not been initialized.");return a.wilddog.DEFAULT[b]()}});k.wilddog=a.wilddog}return a.wilddog||k.wilddog}
;function Xb(a){this.b=E()+E()+E();this.c=a}
Xb.prototype.open=function(a,b,c){function d(){c&&(c(u("USER_CANCELLED")),c=null)}var e=this,f=Na(),g;b.requestId=this.b;b.redirectTo=f.scheme+"://"+f.host+"/blank/page.html";a+=/\?/.test(a)?"":"?";a+=C(b);(g=window.open(a,"_blank","location=no"))&&p(g.addEventListener)?(g.addEventListener("loadstart",function(a){var b;if(b=a&&a.url)a:{try{var r=document.createElement("a");r.href=a.url;b=r.host===f.host&&"/blank/page.html"===r.pathname;break a}catch(U){}b=!1}b&&(a=La(a.url),g.removeEventListener("exit",
d),g.close(),a=new ra(null,null,{requestId:e.b,requestKey:a}),e.c.requestWithCredential("/auth/session",a,c),c=null)}),g.addEventListener("exit",d)):c(u("TRANSPORT_UNAVAILABLE"))};Xb.isAvailable=function(){return!NODE_CLIENT&&ja()};Xb.prototype.D=function(){return"redirect"};function Yb(a){if(!a.window_features||"undefined"!==typeof navigator&&(-1!==navigator.userAgent.indexOf("Fennec/")||-1!==navigator.userAgent.indexOf("Firefox/")&&-1!==navigator.userAgent.indexOf("Android")))a.window_features=void 0;a.window_name||(a.window_name="_blank");this.b=a}
Yb.prototype.open=function(a,b,c){function d(a){g&&(document.body.removeChild(g),g=void 0);U&&(U=clearInterval(U));Ja("message",e);Ja("unload",d);if(r&&!a)try{r.close()}catch(b){h.postMessage("die",m)}r=h=void 0}function e(a){if(a.origin===m)try{var b=x(a.data);"ready"===b.a?h.postMessage(jc,m):"error"===b.a?(d(!1),c&&(c(b.d),c=null)):"response"===b.a&&(d(b.forceKeepWindowOpen),c&&(c(null,b.d),c=null))}catch(e){}}var f=la(),g,h;if(!this.b.relay_url)return c(Error("invalid arguments: origin of url and relay_url must match"));
var m=Ka(a);if(m!==Ka(this.b.relay_url))c&&setTimeout(function(){c(Error("invalid arguments: origin of url and relay_url must match"))},0);else{f&&(g=document.createElement("iframe"),g.setAttribute("src",this.b.relay_url),g.style.display="none",g.setAttribute("name","__winchan_relay_frame"),document.body.appendChild(g),h=g.contentWindow);a+=(/\?/.test(a)?"":"?")+C(b);var r=window.open(a,this.b.window_name,this.b.window_features);h||(h=r);var U=setInterval(function(){r&&r.closed&&(d(!1),c&&(c(u("USER_CANCELLED")),
c=null))},500),jc=w({a:"request",d:b});Ia("unload",d);Ia("message",e)}};
Yb.isAvailable=function(){return!NODE_CLIENT&&"postMessage"in window&&!ka()&&!(ja()||"undefined"!==typeof navigator&&(navigator.userAgent.match(/Windows Phone/)||window.Windows&&/^ms-appx:/.test(location.href))||"undefined"!==typeof navigator&&"undefined"!==typeof window&&(navigator.userAgent.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i)||navigator.userAgent.match(/CriOS/)||navigator.userAgent.match(/Twitter for iPhone/)||navigator.userAgent.match(/FBAN\/FBIOS/)||window.navigator.standalone))&&
!("undefined"!==typeof navigator&&navigator.userAgent.match(/PhantomJS/))};Yb.prototype.D=function(){return"popup"};function Zb(a){var b={};try{var c=a.split("."),d=Pb(c[0])||"",e=Pb(c[1])||"";x(d);b=x(e);delete b.d}catch(f){console.warn("error",f)}a=b;return"object"===typeof a&&a.hasOwnProperty("iat")?ia(a,"iat"):null};function $b(a,b,c){this.c=["session",b.$,b.w,a].join(":");this.b=c}$b.prototype.set=function(a,b){if(!b)if(this.b.length)b=this.b[0];else throw Error("wd.auth.SessionManager : No storage options available!");b.set(this.c,a)};$b.prototype.get=function(){var a=Ua(this.b,q(this.f,this)),a=Ta(a,function(a){return null!==a});Wa(a,function(a,c){return Zb(c.idToken)-Zb(a.idToken)});return 0<a.length?a.shift():null};$b.prototype.f=function(a){try{var b=a.get(this.c);if(b.idToken)return b;ac(this)}catch(c){}return null};
function ac(a){Ga(a.b,function(b){b.remove(a.c)})};function Bb(a,b){if(!n(b))throw Error(ua(a,1,!1)+"must be a valid string.");}function Q(a,b){if(!ba(b)||null===b)throw Error(ua(a,1,!1)+"must be a valid object.");};function bc(a,b,c){this.u=a;this.j=a.app;this.c=b;this.f=new $b(this.j.name,b,[qa,y]);this.m=null;this.h=c;cc(this)}function cc(a){y.get("redirect_request_id")&&dc(a);var b=a.f.get();b&&b.idToken?Gb(a,b.idToken,function(c,d){if(!c&&d){var e={signIn:!0};e.currentUser=d;e.idToken=b.idToken;S(a,e);ec(a,e,{})}else S(a,null)}):S(a,null)}function fc(a,b,c,d){b&&b.idToken?gc(a,b.idToken,c,d):(S(a,null),T(d,Error("No idToken found in response.")))}
function gc(a,b,c,d){Gb(a,b,function(e,f){if(!e&&f){var g={signIn:!0};g.currentUser=f;g.idToken=b;S(a,g);ec(a,g,c);T(d,e,f)}else S(a,null),T(d,e)})}
function R(a,b,c){X(a);var d=new ra({},{},b||{}),e;e="POST";switch(b.providerId||b.provider){case "password":b="verifyPassword";break;case "anonymous":b="verifyAnonymous";break;case "custom":b="verifyCustomToken";break;default:b="credential",e="GET"}if(!b)throw Error("Unknown provider '"+provider+"'.");e={path:b,method:e};d.i._method=e.method;hc(a,[F,D],"/auth/"+e.path,d,c)}
function Db(a,b,c,d){X(a);var e=[Yb,Xb];c=z(c);b.id?(c.i.providerId=b.id,c.i.scope=b.scope||"",c.i.appId=a.c.w,c.G.window_features="menubar=yes,modal=yes,alwaysRaised=yeslocation=yes,resizable=yes,scrollbars=yes,status=yes,height=625,width=625,top="+("object"===typeof screen?.5*(screen.height-625):0)+",left="+("object"===typeof screen?.5*(screen.width-625):0),c.G.relay_url=Oa(a.c.w),c.G.requestWithCredential=q(a.b,a),hc(a,e,"/auth/oauth",c,d)):setTimeout(function(){T(d,u("TRANSPORT_UNAVAILABLE_FOR_UNKNOWN_PROVIDER"))},
0)}function Eb(a,b,c,d){X(a);var e=[Qa];c=z(c);b.id?(c.i.providerId=b.id,c.i.scope=b.scope||"",c.i.appId=a.c.w,y.set("redirect_client_options",c.H),hc(a,e,"/auth/oauth",c,d)):T(d,u("TRANSPORT_UNAVAILABLE"))}
function dc(a){var b=y.get("redirect_request_id");if(b){var c=y.get("redirect_client_options"),d=[F,D],b={requestId:b,requestKey:La(document.location.hash)},c=new ra(c,{},b);try{document.location.hash=document.location.hash.replace(/&__wilddog_request_key=([a-zA-z0-9]*)/,"")}catch(e){}hc(a,d,"/auth/session",c,function(){y.remove("redirect_request_id");y.remove("redirect_client_options")}.bind(a))}}
function ic(a,b,c){X(a);b=z(b);b.i._method="POST";a.b("/auth/signupNewUser",b,function(b,e){!b&&e&&e.idToken?gc(a,e.idToken,null,c):T(c,b)})}function Cb(a,b,c,d){var e={idToken:c.idToken},f=c.photoURL||a.m.currentUser.photoURL,g=c.displayName||a.m.currentUser.displayName;switch(b){case "unlink":e.deleteProvider=c.deleteProvider;break;case "profile":e.photoUrl=f,e.displayName=g}kc(a,e,function(b,c){b?T(d,b):(a.m.currentUser.displayName=g,a.m.currentUser.photoURL=f,ec(a,a.m),T(d,b,c))})}
function Ab(a,b,c){kc(a,b,function(b,e){b?T(c,b):fc(a,e,{},c)})}function kc(a,b,c){b=z(b);b.i._method="POST";b.i.idToken=a.m.idToken;a.b("/auth/setAccountInfo",b,function(a,b){a?T(c,a):T(c,a,b)})}function Gb(a,b,c){X(a);b=z({idToken:b});b.i._method="POST";a.b("/auth/getAccountInfo",b,function(b,e){b?T(c,b):T(c,b,Ib(a,e))})}function zb(a,b,c){X(a);b=z({idToken:b});b.i._method="POST";a.b("/auth/deleteAccount",b,function(b,e){!b&&e&&"ok"==e.status&&a.m&&(S(a,null),T(void 0,null));T(c,b)})}
function Fb(a,b,c){X(a);b=z(b);b.i._method="POST";a.b("/auth/getOobConfirmationCode",b,function(a,b){T(c,a,b)})}bc.prototype.J=function(a,b){X(this);var c=z({email:a});c.i._method="POST";this.b("/auth/getProvider",c,function(a,c){a?T(b,a):T(b,a,c.allProviders||[])})};bc.prototype.b=function(a,b,c){lc(this,[F,D],a,b,c)};function hc(a,b,c,d,e){lc(a,b,c,d,function(b,c){!b&&c&&c.idToken?fc(a,c,d.H,function(a,b){a?T(e,a):T(e,null,b)}):T(e,b||u("UNKNOWN_ERROR"))})}
function lc(a,b,c,d,e){b=Ta(b,function(a){return"function"===typeof a.isAvailable&&a.isAvailable()});0===b.length?setTimeout(function(){T(e,u("TRANSPORT_UNAVAILABLE"))},0):(b=b.shift(),d.G.method=d.i._method,b=new b(d.G),d=na(d.i),d.v=(NODE_CLIENT?"node-":"js-")+CLIENT_VERSION,d.transport=b.D(),d.suppress_status_codes=!0,a=Ma()+"/"+a.c.w+c,b.open(a,d,function(a,b){if(a)T(e,a);else if(b&&b.error){var c=Error(b.error.message);c.code=b.error.code;c.details=b.error.details;T(e,c)}else T(e,null,b)}))}
function ec(a,b,c){ac(a.f);c=c||{};var d=qa;"sessionOnly"===c.remember&&(d=y);"none"!==c.remember&&a.f.set(b,d)}function S(a,b){a.m=b;a.u.currentUser=b&&b.signIn?b.currentUser:null;a.h&&a.h(null!==b);b&&b.signIn||ac(a.f);a.j.emit(W.s,b||{signIn:!1})}function X(a){if(a.c.S)throw Error("This custom Wilddog server ('"+a.c.domain+"') does not support delegated login.");};Wb().__regService("auth",function(a){return new Y(a)});
function Y(a){if(!a.options.authDomain)throw Error("Could not find 'authDomain' in options.");var b=this;this.c=function(a){var b=/^([a-zA-Z0-9\-_]+)\.([a-z]+)\.com/.exec(a.toLowerCase());if(!b)throw Error("Bad 'authDomain' format '"+a+"'.");return{w:b[1],xa:b[2],sa:b[0],$:"",S:"wilddog"!==b[2]}}(a.options.authDomain);this.app=a;this.b=new bc(this,this.c);this.app.bind(W.O,function(a){var d=b.b;a=a.reason;d.m=null;d.u.currentUser=null;d.j.emit(W.s,{signIn:!1,reason:a});d.h&&d.h(!1);ac(d.f)})}
Y.prototype.Y=function(a){function b(b){var e;if(!(e=b&&b.signIn)){var f=c.b;e=y.get("redirect_request_id");f=f.f.get();e=!(e||f&&f.idToken)}e&&a(b&&b.signIn?b.currentUser:null)}var c=this;A("wilddog.auth().onAuthStateChanged",1,1,arguments.length);B("wilddog.auth().onAuthStateChanged",1,a,!1);this.app.bind(W.s,b);return function(){c.app.unbind(W.s,b)}};Y.prototype.onAuthStateChanged=Y.prototype.Y;
Y.prototype.ea=function(a){A("wilddog.auth().signInAnonymously",0,1,arguments.length);B("wilddog.auth().signInAnonymously",1,a,!0);var b=new K;ic(this.b,{},L(b,a));return b.b};Y.prototype.signInAnonymously=Y.prototype.ea;Y.prototype.da=function(a,b){A("wilddog.auth().sendPasswordResetEmail",1,2,arguments.length);B("wilddog.auth().sendPasswordResetEmail",2,b,!0);var c=new K;Fb(this.b,{requestType:"RESET_PASSWORD",email:a},L(c,b));return c.b};Y.prototype.sendPasswordResetEmail=Y.prototype.da;
Y.prototype.J=function(a,b){A("wilddog.auth().fetchProvidersForEmail",1,2,arguments.length);B("wilddog.auth().fetchProvidersForEmail",2,b,!0);var c=new K;this.b.J(a,L(c,b));return c.b};Y.prototype.fetchProvidersForEmail=Y.prototype.J;Y.prototype.ga=function(a,b){A("wilddog.auth().signInWithCustomToken",1,2,arguments.length);B("wilddog.auth().signInWithCustomToken",2,b,!0);var c=new K;R(this.b,{providerId:"custom",token:a},L(c,b));return c.b};Y.prototype.signInWithCustomToken=Y.prototype.ga;
Y.prototype.ha=function(a,b,c){A("wilddog.auth().signInWithEmailAndPassword",2,3,arguments.length);B("wilddog.auth().signInWithEmailAndPassword",3,c,!0);var d=new K;R(this.b,{providerId:"password",password:b,email:a},L(d,c));return d.b};Y.prototype.signInWithEmailAndPassword=Y.prototype.ha;Y.prototype.ka=function(a){A("wilddog.auth().signOut",0,1,arguments.length);B("wilddog.auth().signOut",1,a,!0);var b=new K,c=L(b,a);S(this.b,null);T(c,null);return b.b};Y.prototype.signOut=Y.prototype.ka;
Y.prototype.P=function(a,b,c){A("wilddog.auth().createUserWithEmailAndPassword",2,3,arguments.length);B("wilddog.auth().createUserWithEmailAndPassword",3,c,!0);var d=new K;ic(this.b,{email:a,password:b},L(d,c));return d.b};Y.prototype.createUserWithEmailAndPassword=Y.prototype.P;Y.prototype.ia=function(a,b){A("wilddog.auth().signInWithPopup",1,2,arguments.length);Q("wilddog.auth().signInWithPopup",a);var c=new K;Db(this.b,a,{authType:"login"},L(c,b));return c.b};Y.prototype.signInWithPopup=Y.prototype.ia;
Y.prototype.ja=function(a,b){A("wilddog.auth().signInWithRedirect",1,2,arguments.length);Q("wilddog.auth().signInWithRedirect",a);var c=new K;Eb(this.b,a,{authType:"login"},L(c,b));return c.b};Y.prototype.signInWithRedirect=Y.prototype.ja;
Y.prototype.fa=function(a,b){A("wilddog.auth().signInWithCredential",1,2,arguments.length);Q("wilddog.auth().signInWithCredential",a);var c={};"password"==a.provider?(c.providerId=a.provider,c.email=a.email,c.password=a.password):(c.providerId=a.provider,c.accessToken=a.accessToken,c.openId=a.openId||a.email);c.authType="login";var d=new K;R(this.b,c,L(d,b));return d.b};Y.prototype.signInWithCredential=Y.prototype.fa;var Z={Z:{}};Z.Z.ra={};Z=Wb();
(function(a){a.auth=a.auth?a.auth:{};[{id:"password",name:"Email",A:"email",B:"password"},{id:"qq",name:"QQ",A:"accessToken",B:"openId"},{id:"weibo",name:"Weibo",A:"accessToken",B:"openId"},{id:"weixin",name:"Weixin",A:"accessToken",B:"openId"},{id:"weixinmp",name:"Weixinmp",A:"accessToken",B:"openId"}].forEach(function(b){a.auth[b.name+"AuthProvider"]=function(){this.id=b.id;this.addScope=function(a){this.scope=a}};a.auth[b.name+"AuthProvider"].credential=function(a,d){var e={};e.provider=b.id;e[b.A]=
a;e[b.B]=d;return e}})})(Z);1!=NODE_CLIENT?("object"==typeof module&&module.exports&&(module.exports=Z),"function"==typeof define&&define.amd&&define("wilddog",[],function(){return Z}),window?window.wilddog=Z:WorkerGlobalScope&&self&&(self.wilddog=Z)):module.exports=Z;
