(function () {'use strict';
    angular.module('app.image-service', [])

    .service('QiNiu', function ($rootScope) {
      var self = this;
      ...
      var ak = '6xkgmLbvNnQ3WinYsM81KEkvVndYPdAhepTxzam8',
          sk = 'r4cvVSDeUTJ6UP6FCGUJpSOi7MkcA-XP2a4ANgjp';
      var bucket = 'moments';
      ...
      this.uploader = Qiniu.uploader({
        ...
        domain: 'http://ogmn2ugz8.bkt.clouddn.com/',   //bucket 域名，下载资源时用到，**必需**
